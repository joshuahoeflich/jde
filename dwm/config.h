...
static const char *scrinccmd[] = { "brightnessctl", "s", "10%+", "&&", "brightness", "--block", "00-brightness", NULL };
static const char *scrdeccmd[] = { "brightnessctl", "s", "10%-", "&&", "brightness", "--block", "00-brightness", NULL };
